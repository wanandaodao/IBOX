  ...
  <view class="setting-container">
    ...
    <view class="setting-list">
      ...
      <view class="setting-group">
        ...
        <view class="setting-item" @click="showToast('实名认证功能正在开发中')">
          <view class="item-left">
        ...
        <view class="setting-item" @click="showToast('安全中心功能正在开发中')">
          <view class="item-left">
        ...
        <view class="setting-item" @click="showToast('开具发票功能正在开发中')">
          <view class="item-left">
      ...
      <!-- 第二组 -->
      <view class="setting-group">
        <view class="setting-item" @click="showToast('帮助中心功能正在开发中')">
          <view class="item-left">
